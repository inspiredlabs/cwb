...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: "/./_app/start-71d10156.js",
      css: ["/./_app/assets/start-a8cd1609.css"],
      js: ["/./_app/start-71d10156.js", "/./_app/chunks/vendor-9f84a31e.js"]
    },
    fetched: void 0,
    floc: false,
...
var manifest = {
  ...
  routes: [
    ...
    {
      type: "page",
      pattern: /^\/about-us\/introduction\/?$/,
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/about-us/introduction.md"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
      pattern: /^\/about-us\/test\/?$/,
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/about-us/test.md"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
      pattern: /^\/about-us\/x\/?$/,
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/about-us/x.md"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
...
var module_lookup = {
  ...
  "src/routes/about-us/introduction.md": () => Promise.resolve().then(function() {
    return introduction;
  }),
  "src/routes/about-us/test.md": () => Promise.resolve().then(function() {
    return test;
  }),
  "src/routes/about-us/x.md": () => Promise.resolve().then(function() {
    return x;
  }),
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "/./_app/pages/__layout.svelte-36eb3836.js", "css": ["/./_app/assets/pages/__layout.svelte-27e2c18f.css"], "js": ["/./_app/pages/__layout.svelte-36eb3836.js", "/./_app/chunks/vendor-9f84a31e.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "/./_app/error.svelte-bdc80dc1.js", "css": [], "js": ["/./_app/error.svelte-bdc80dc1.js", "/./_app/chunks/vendor-9f84a31e.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "/./_app/pages/index.svelte-6079390f.js", "css": ["/./_app/assets/pages/index.svelte-078f1a0b.css"], "js": ["/./_app/pages/index.svelte-6079390f.js", "/./_app/chunks/vendor-9f84a31e.js"], "styles": [] }, "src/routes/about-us/introduction.md": { "entry": "/./_app/pages/about-us/introduction.md-a729a657.js", "css": [], "js": ["/./_app/pages/about-us/introduction.md-a729a657.js", "/./_app/chunks/vendor-9f84a31e.js"], "styles": [] }, "src/routes/about-us/test.md": { "entry": "/./_app/pages/about-us/test.md-a70c8b2b.js", "css": [], "js": ["/./_app/pages/about-us/test.md-a70c8b2b.js", "/./_app/chunks/vendor-9f84a31e.js"], "styles": [] }, "src/routes/about-us/x.md": { "entry": "/./_app/pages/about-us/x.md-2148d7bc.js", "css": [], "js": ["/./_app/pages/about-us/x.md-2148d7bc.js", "/./_app/chunks/vendor-9f84a31e.js"], "styles": [] }, "src/routes/about.svelte": { "entry": "/./_app/pages/about.svelte-903eddf3.js", "css": ["/./_app/assets/pages/about.svelte-4db5be0d.css"], "js": ["/./_app/pages/about.svelte-903eddf3.js", "/./_app/chunks/vendor-9f84a31e.js"], "styles": [] }, "src/routes/todos/index.svelte": { "entry": "/./_app/pages/todos/index.svelte-8322d5a1.js", "css": ["/./_app/assets/pages/todos/index.svelte-05e41044.css"], "js": ["/./_app/pages/todos/index.svelte-8322d5a1.js", "/./_app/chunks/vendor-9f84a31e.js"], "styles": [] } };
...
var logo = "/_app/assets/cwb.ac7c16d0.svg";
var css$5 = {
...
var Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_page();
  return `<header class="${"svelte-1twf6mk"}"><div class="${"corner svelte-1twf6mk"}"><a class="${"h3 h3 svelte-1twf6mk"}" href="${"/"}"><img style="${"fill:#d42900"}"${add_attribute("src", logo, 0)}${add_attribute("alt", alt, 0)} class="${"svelte-1twf6mk"}"></a></div>
...
var Introduction = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<p><a href="${"https://www.youtube.com/watch?v=erx9czQsY2Q"}" rel="${"nofollow"}">Joe Rogan Breathing with \u201CThe Iceman\u201D Wim Hof (from Joe Rogan Experience #712)</a>.</p>
<p>These boost the body\u2019s natural healing capability.</p>
<p>x</p>
<ul><li>regulates the body\u2019s chemistry</li>
<li>Autonomic Nervous System, etc\u2026</li></ul>
<p>Improve concentration:</p>
<ul><li>tolerance to pain, etc.</li>
<li>etc.</li></ul>
<p>increase perception</p>
<ul><li>xyx</li></ul>
<p>The University Medical Center St. Radboud in Nijmegen, Netherlands \u2013&gt;
Wayne State University School of Medicine: study published February 10 in the journal <em>Neuroimage</em>.</p>
<ul><li>regulation of skin temperature and core body temperature. Unaffected by frostbite, Otto Muzik quote: <a href="${"https://web.archive.org/web/20180420012309/http://research.wayne.edu/news/novel-study-is-first-to-demonstrate-brain-mechanisms-that-give-the-iceman-unusual-resistance-to-cold-29291"}" rel="${"nofollow"}">https://web.archive.org/web/20180420012309/http://research.wayne.edu/news/novel-study-is-first-to-demonstrate-brain-mechanisms-that-give-the-iceman-unusual-resistance-to-cold-29291</a>. </li>
<li>anti-depressant effects: upper brain stem controls sensory pain using natural opioids and cannabinoids. Ideal for treating mood and anxiety disorders, Wayne State University Prof: Vaibhav Diwadkar: <a href="${"https://web.archive.org/web/20180420012309/https://wayne.edu/people/ax3112/"}" rel="${"nofollow"}">https://web.archive.org/web/20180420012309/https://wayne.edu/people/ax3112/</a></li></ul>
<p>Claims:</p>
<ul><li>Sleep like a baby  </li>
<li>Creativity  </li>
<li>Recovery rate  </li>
<li>How does WHM Reduce inflammation?  </li>
<li>The six ways to reduce inflammation.  </li>
<li>Reducing inflamation works by\u2026  </li></ul>
<p>\u2022 Cold exposure constricts the blood vessels and boosts metabolism. Thermogenesis takes place in the body\u2019s brown fat as part of a natural heat generation process. LINK:  </p>
<ul><li>Reduce stress level  </li>
<li>Have you come across the idea of Eustress?  </li>
<li>Burn fat  </li>
<li>Boundless energy  </li>
<li>Mood improvement  </li>
<li>Boost your athletic limits</li></ul>
<figure class="${"w-third ml-auto mr-auto"}"><svg class="${"w-100 h4 h5-l mt1 cf v-mid"}" viewBox="${"0 0 128 128"}" alt="${"breathing"}"><use xlink:href="${"#whm"}" style="${"color:#003845"}"></use><use xlink:href="${"#breathing"}"></use></svg></figure>
...
<figure class="${"w-third ml-auto mr-auto"}"><svg class="${"w-100 h4 h5-l mt1 cf v-mid"}" viewBox="${"0 0 128 128"}" alt="${"focus"}"><use xlink:href="${"#whm"}" style="${"color:#f8a619"}"></use><use xlink:href="${"#focus"}"></use></svg></figure>
<p><strong>Mindset/Focus</strong> is the golden thread that links the practice together. Breathing techniques and Cold Exposure require patience and dedication in order to be fully mastered. These techniques solidify a foundation of inner confidence and will power to go beyond limiting belief patterns and become strong, happy and healthy.</p>
<figure class="${"w-third ml-auto mr-auto"}"><svg class="${"w-100 h4 h5-l mt1 cf v-mid"}" viewBox="${"0 0 128 128"}" alt="${"exposure"}"><use xlink:href="${"#whm"}" style="${"color:#9cc5c9"}"></use><use xlink:href="${"#exposure"}"></use></svg></figure>
<p><strong>Cold</strong> is your warm friend. Exposing your body to the cold creates a cascade of benefits including, the build up of brown adipose tissue and subsequent fat loss, reduced inflammation to facilitate a fortified immune system, balance hormone levels, improved sleep quality, and the production of endorphins \u2013 the feel-good chemicals in the brain that naturally elevate your mood.</p>
<p><a href="${"https://www.youtube.com/watch?v=nzCaZQqAs9I"}" rel="${"nofollow"}"><img src="${"images/hqdefault-1x.jpg"}" alt="${"Photo of Wim Hof"}"></a></p>`;
});
...
var Test = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `
<h4>Background</h4>
<h5>In recognition</h5>
<p>My Mum would say, I was attracted to many different things \u2013 <em>too many!</em> Although she has always been supportive during each and every chapter.</p>`;
});
